...
def is_var(sym):
    ...
    if isinstance(t, str) and t.lower() in ("var","logic","reg","integer"):
        return True
    if sym.get("is_var") is True:
        return True
    return False
...
def main():
    ...
    for s in get_symbols(payload):
        ...
        if r == 0 and w == 0:
            ...
            out.append(to_viol("decl.unused.var", "'{}' declared but never used".format(name), loc))
