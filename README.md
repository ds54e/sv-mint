...
| CLI で出たルールをすぐ直したい人 | `rule_id` ごとの背景・ステージ・Severity・対処方法 | [docs/rule_detail_user.md](docs/rule_detail_user.md) |
| ルール仕様を正確に把握したい人 | ルール一覧、ID、検出条件、典型メッセージ | [docs/rule_reference.md](docs/rule_reference.md) |
...
- `docs/rule_detail_user.md`: CLI で出た `rule_id` を直ちに調べられるユーザー向け対処ガイド。
